...
SITENAME = u'karlgrz'
SITESUBTITLE = u'symphonic code: my gift to the coding gods'
...
# Social widget
#SOCIAL = ('twitter: @karl_grz', 'http://twitter.com/karl_grz')
...
# Sharing
TWITTER_USER = 'karl_grz'
GOOGLE_PLUS_USER = '+KarlGrzeszczak'
